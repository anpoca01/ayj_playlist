$(function () {
  var playerTrack = $("#player-track"),
    ...
    trackUrl = [
      "ayj/killer (with Karina).wav",
      "ayj/Ending Credit.WAV",
      "ayj/Dreaming.WAV",
      "ayj/Nerdy Love (with MIMI).WAV",
      "ayj/You, Clouds, Rain.wav",
      "ayj/This Wish.wav",
      "ayj/Nobody gets me Covered by IVE ANYUJIN.wav",
      "ayj/Tangled Up In Me.wav",
      "ayj/Born This Way (Youngji).WAV",
      "ayj/A Thousand Miles.WAV",
      "ayj/ride.WAV",
      "ayj/Good Things.WAV",
      "ayj/I LOVE YOU 3000.WAV",
      "ayj/Event Horizon.WAV",
      "ayj/Nappa.WAV",
      "ayj/Gravity (with Liz).WAV",
      "ayj/Issues.WAV"
    ],
